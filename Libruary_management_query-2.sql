...
--Q.3 Delete a Record from the Issued Status Table -- Objective: Delete the record with issued_id = 'IS121' from the issued_status table.
...
--Q16.Find Employees with the Most Book Issues Processed:
...
SELECT e.emp_name,
       b.*,
	   COUNT(ist.issued_id) as number_books
